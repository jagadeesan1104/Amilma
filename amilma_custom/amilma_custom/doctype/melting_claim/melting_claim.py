...
def get_item_rate(item):
	...
	if get_uom_and_pieces[0] == "Box":
		...
		if get_item_price:
			...
			frappe.throw(_('Please Check the Item Price List in price list '))	
		return get_rate
	else:
